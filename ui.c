 ...
 *
 * ui_disasm.c - Main user interface to AVR disassembler. Takes care of program
 *  arguments, setting disassembly formatting options, and program file type recognition. 
 *
 */
...
static void printVersion(FILE *stream) {
	fprintf(stream, "vAVRdisasm version 1.7 - 05/27/2010.\n");
